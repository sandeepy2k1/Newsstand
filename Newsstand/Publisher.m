    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_LOW, 0),
                   ^{
                     /*  NSArray *tmpIssues = [NSArray arrayWithContentsOfURL:[NSURL URLWithString:@"http://www.viggiosoft.com/media/data/blog/newsstand/issues.plist"]];*/
                       ...
                       NSString *finalPath = [path stringByAppendingPathComponent:@"issues.plist"];
                       NSArray *tmpIssues = [[NSArray arrayWithContentsOfFile:finalPath] retain];
                       NSLog(@"_list%@",tmpIssues);
